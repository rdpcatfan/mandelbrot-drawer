...
namespace Mandelbrot
{
    public partial class HelpForm : Form
    {
        ...
        public HelpForm()
        {
            ...
            helpText.Add("Nieuw", "Door op 'Nieuw' te klikken wordt de mandelbrot terug gezet naar de oorspronkelijke beginwaarden. Het huidige kleurenschema blijft behouden.");
            helpText.Add("Afbeelding opslaan", "U kunt de huidige afbeelding opslaan als een bitmap, jpeg of gif afbeelding. Om verlies van kwaliteit te voorkomen kan de afbeelding echter het beste als bitmap worden opgeslagen.");
